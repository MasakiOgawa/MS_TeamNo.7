        ...
        if( bPoseFlg == false )
        {
            ...
            { 
                ...
                if( EnemyObj != null && EnemyObj.tag == "Up" )
                {
                    ...
                    {
                        ScoreManagerClass.ActiveTrue( new Vector2( -240.0f , -180.0f ) , ScoreManager.EVALUATION.EVALUATION_EXCELLENT , 0 );
                    ...
                    {
                        ScoreManagerClass.ActiveTrue( new Vector2( -290.0f , -180.0f ) , ScoreManager.EVALUATION.EVALUATION_FINE , 0 );
                        MirrorTmp = new Vector3( MirrorBall.transform.position.x , MirrorBall.transform.position.y + 1.0f , MirrorBall.transform.position.z );
                        ExplodeController.Create( Tmp.transform.position , EnemyObj.transform.position , MirrorTmp ,
                    ...
                    {
                          ScoreManagerClass.ActiveTrue(new Vector2( -310.0f , -180.0f ) , ScoreManager.EVALUATION.EVALUATION_BAD , 0 );
                        MirrorTmp = new Vector3( MirrorBall.transform.position.x , MirrorBall.transform.position.y + 1.0f , MirrorBall.transform.position.z );
                         ExplodeController.Create( Tmp.transform.position , EnemyObj.transform.position , MirrorTmp ,
                ...
                {
                    ScoreManagerClass.ActiveTrue(new Vector2( -290.0f , -180.0f ) , ScoreManager.EVALUATION.EVALUATION_MISS , 0 );
                }
                ...
                Input.GetKeyDown( KeyCode.RightArrow ) )
            {
                ...
                { 
                  ...
                  BounusEffect.Create( Tmp );
                    ScoreManagerClass.ExcellentCount( 0 );
                }
