...
public class PlayerLeft : MonoBehaviour
{
    ...
    public void Pose( )
    {
        ...
        {
            //上
            if( PlayerManagerObj.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_L1 ) == Example_gyro.JOYCON_STATE.STATE_UP_TRIGGER )
            {
                //敵の番号を取得
            ...
            //下
            else if( PlayerManagerObj.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_L1 ) == Example_gyro.JOYCON_STATE.STATE_DOWN_TRIGGER )
            {
                //敵の番号を取得
                TmpObj = EnemyManagerObj.GetComponent< EnemyManager >( ).GetTarget( );
            ...
            //左
            else if( PlayerManagerObj.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_L1 ) == Example_gyro.JOYCON_STATE.STATE_LEFT_TRIGGER )
            {
                //敵の番号を取得
                TmpObj = EnemyManagerObj.GetComponent< EnemyManager >( ).GetTarget( );
            ...
            //右
            else if( PlayerManagerObj.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_L1 ) == Example_gyro.JOYCON_STATE.STATE_RIGHT_TRIGGER )
            {
                //敵の番号を取得
                TmpObj = EnemyManagerObj.GetComponent< EnemyManager >( ).GetTarget( );
