...
public class PlayerCenter : MonoBehaviour
{
    ...
    public void Pose( )
    {
        ...
        {
            //上
            if( PlayerManagerPrefab.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_R1 ) == Example_gyro.JOYCON_STATE.STATE_UP_TRIGGER )
            {
                //敵の番号を取得
            ...
            //下
            else if( PlayerManagerPrefab.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_R1 ) == Example_gyro.JOYCON_STATE.STATE_DOWN_TRIGGER )
            {
                //敵の番号を取得
                ObjectTmp = EnemyManagerPrefab.GetComponent< EnemyManager >( ).GetTarget( );
            ...
            //左
            else if( PlayerManagerPrefab.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_R1 ) == Example_gyro.JOYCON_STATE.STATE_LEFT_TRIGGER )
            {
                //敵の番号を取得
                ObjectTmp = EnemyManagerPrefab.GetComponent< EnemyManager >( ).GetTarget( );
            ...
            //右
            else if( PlayerManagerPrefab.GetComponent< Example_gyro >( ).GetJoyconState( Example_gyro.JOYCON_TYPE.JOYCON_R1 ) == Example_gyro.JOYCON_STATE.STATE_RIGHT_TRIGGER )
            {
                //敵の番号を取得
                ObjectTmp = EnemyManagerPrefab.GetComponent< EnemyManager >( ).GetTarget( );
